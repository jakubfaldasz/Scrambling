...
class DvbScrambler(Scrambler_BaseClass):

    def __init__(self, input_seq=[], treat_as_pseudorandom_generator=False):
        # Scrambler_BaseClass.__init__(self, 15, 14, 13)
        Scrambler_BaseClass.__init__(self, input_seq=input_seq, val1_index=14, val2_index=13, register_length=15, treat_as_pseudorandom_generator=treat_as_pseudorandom_generator)
